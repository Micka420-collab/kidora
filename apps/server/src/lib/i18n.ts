...
const fr = {
  ...
  overview: {
    ...
    recentActivity: "Activité récente de la famille",
    seeAll: "Tout voir",
  ...
  settings: {
    ...
    notifSafetyNote: "🔒 SOS, risque & mots-clés critiques (automutilation, violence) : toujours activés",
  ...
  screen: {
    ...
    unlimited: "Illimité",
    zeroHint: "0 = illimité (aucune limite ce jour-là). Pour une journée sans écran, utilisez la pause ou une plage de coucher.",
    noDaysBedtime: "Aucun jour coché — cette plage sera ignorée à l'enregistrement.",
    noDaysRoutine: "Choisissez au moins un jour.",
    allTo: "Tout à",
  ...
  devices: {
    ...
    winTurnkey: "⬇️ Télécharger l'installateur prêt-à-l'emploi (Windows)",
    winTurnkeyDesc: "Recommandé : décompressez, double-cliquez « Installer-Kidora.cmd ». Rien à taper — le jeton et l'adresse du serveur sont déjà inclus.",
    winAdvanced: "Options avancées (MSI / ligne de commande)",
    getAgent: "⬇️ Télécharger l'agent Windows (Releases)",
    winInstall: "Installez-le (PowerShell administrateur) — remplacez le nom d'utilisateur Windows de l'enfant :",
    winSourceNote: "Ou depuis les sources (Node.js 18+ requis) :",
    done: "J'ai terminé",
    statusLabel: "Statut",
    ...
    tokenExpired: "Jeton d'enrôlement expiré — cet appareil ne s'est jamais connecté.",
    tokenRegen: "Régénérer le jeton",
    lock: "Verrouiller",
    message: "Message",
...
const en: typeof fr = {
  ...
  settings: {
    ...
    notifSafetyNote: "🔒 SOS, risk & critical keywords (self-harm, violence): always on",
  ...
  screen: {
    ...
    unlimited: "Unlimited",
    zeroHint: "0 = unlimited (no limit that day). For a screen-free day, use the pause or a bedtime window.",
    noDaysBedtime: "No day selected — this window will be dropped on save.",
    noDaysRoutine: "Pick at least one day.",
    allTo: "All to",
    bedtime: "Bedtime",
    add: "Add",
  ...
  devices: {
    ...
    winTurnkey: "⬇️ Download the ready-to-run installer (Windows)",
    winTurnkeyDesc: "Recommended: unzip, then double-click “Installer-Kidora.cmd”. Nothing to type — the token and server address are already included.",
    winAdvanced: "Advanced options (MSI / command line)",
    getAgent: "⬇️ Download the Windows agent (Releases)",
    winInstall: "Install it (PowerShell as admin) — replace the child's Windows username:",
    winSourceNote: "Or from source (requires Node.js 18+):",
    done: "Done",
    statusLabel: "Status",
    ...
    tokenExpired: "Enrollment token expired — this device never connected.",
    tokenRegen: "Regenerate token",
    lock: "Lock",
    message: "Message",
